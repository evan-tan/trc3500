...
public:
    ...
    LeftDigitMap(std::string parity)
    {
        if (parity == "even")
        {
            ld_map = {{"0100111", "0"}, {"0110011", "1"}, {"0011011", "2"}, {"0100001", "3"}, {"0011101", "4"},
                      {"0111001", "5"}, {"0000101", "6"}, {"0010001", "7"}, {"0001001", "8"}, {"0010111", "9"}};
        } else if (parity == "odd")
        {
            ld_map = {{"0001101", "0"}, {"0011001", "1"}, {"0010011", "2"}, {"0111101", "3"}, {"0100011", "4"},
...
public:
    ...
    RightDigitMap()
    {
        rd_map = {{"1110010", "0"}, {"1100110", "1"}, {"1101100", "2"}, {"1000010", "3"}, {"1011100", "4"},
